...
INSERT INTO office_local_blocks (block_id, identity_id, revision, layout, updated_at_ms)
SELECT block_id, identity_id, revision, layout, updated_at_ms FROM office_local_blocks_previous;
