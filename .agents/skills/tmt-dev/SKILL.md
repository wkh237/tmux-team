...
source ownership: edit the canonical skill or provider-only templates,
regenerate committed projections, and verify drift detection. Review semantic
changes and provider invocation behavior; matching generated bytes alone does
not prove that the instructions are correct.
